...
/// <summary>
/// Stage13 PlayScene: 화동 소환진 퍼즐 직전 짧은 안내.
/// </summary>
public class Stage13PlayIntroController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (stage == null || stage.stageNumber != 13)
        {
            enabled = false;
            return;
        }
    ...
    private IEnumerator RunIntro()
    {
        ...
        {
            "시스템|룬을 연결해 저장된 마력을 소환진 중앙으로 전달하세요.",
            "시스템|모든 마력이 연결되면 악마 소환이 시작됩니다.",
            "시스템|마력의 흐름이 끊기지 않도록 소환진을 완성하세요."
        });
    ...
    private void EnsurePanel()
    {
        ...
        if (canvas == null)
        {
            var canvasObject = new GameObject("Stage13IntroCanvas");
        ...
        _panelRoot = new GameObject("Stage13PlayIntroDialogue");
