...
/// <summary>
/// Stage2 PlayScene: 일방향 혈흔 마법진을 그리기 직전 안내.
/// </summary>
public class Stage2PlayIntroController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (stage == null || stage.stageNumber != 2)
        {
            enabled = false;
            return;
        }
    ...
    private IEnumerator RunIntro()
    {
        ...
        {
            "주인공|많은 피를 뽑아낼 수는 없겠지…… 그러니까 한 번 지나간 곳은 다시 돌아갈 수 없어.",
            "주인공|선을 낭비하면 끝장이야. 신중하게 움직여야 해……!"
        });
    ...
    private void EnsurePanel()
    {
        ...
        if (canvas == null)
        {
            var canvasObject = new GameObject("Stage2IntroCanvas");
        ...
        _panelRoot = new GameObject("Stage2PlayIntroDialogue");
