...
/// <summary>
/// Stage31 PlayScene: 마력 충전 직전 안내.
/// </summary>
public class Stage31PlayIntroController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (stage == null || stage.stageNumber != 31)
        {
            enabled = false;
            return;
        }
    ...
    private IEnumerator RunIntro()
    {
        ...
        yield return ShowDialogue(new[]
        {
            ...
            "벨리안|전체 경로를 확인한 뒤 움직이십시오.",
            "루시아|마력이 끊기지 않도록 남은 마력석을 확인해!",
            "주인공|좋아. 이번에는 빨리 끝내고 기록을 살펴볼 거야."
        });
    ...
    private void EnsurePanel()
    {
        ...
        if (canvas == null)
        {
            var canvasObject = new GameObject("Stage31IntroCanvas");
        ...
        _panelRoot = new GameObject("Stage31PlayIntroDialogue");
